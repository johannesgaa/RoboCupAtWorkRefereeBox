...
public class CompetitionLogging implements TaskListener {
	...
	@Override
	public void cbtTaskSpecChanged(CbtTask cbtTask, int pos,
			ArrayList<CbtTask> cbtTaskList) {
		setTaskState(pos, cbtTask.getState());	
	}

	@Override
	public void pptTaskSpecChanged(PptTask pptTask, int pos,
			ArrayList<PptTask> pptTaskList) {
		setTaskState(pos, pptTask.getState());
	}
}
