...
public class BTTTaskController implements TaskController {
	...
	public void tabChanged(ChangeEvent event, BaseController controller)
	{
		...
		controller.getTaskSpec().notifyBttTaskSpecChanged(new BttTask(), 0, controller.getTaskSpec().getBttTaskList());
	}
